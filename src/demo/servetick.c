/** @file servetick.c
 *
 * NGHTTP2 based server which streams a never ending counter at 1 line per second.
 * Demonstrates producer limited flow control.
 */
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
